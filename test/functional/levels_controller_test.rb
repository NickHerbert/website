...
class LevelsControllerTest < ActionController::TestCase
  ...
  test "should create level" do
    assert_difference('Level.count') do
      post :create, level: { content: @level.content, description: @level.description, download: @level.download, game: @level.game, logo: @level.logo, title: @level.title }
    end
  ...
  test "should update level" do
    put :update, id: @level, level: { content: @level.content, description: @level.description, download: @level.download, game: @level.game, logo: @level.logo, title: @level.title }
    assert_redirected_to level_path(assigns(:level))
  end
